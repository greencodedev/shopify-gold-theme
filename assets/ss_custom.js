(function($) {
  ...
  var ss = {
    ...
    initcolor: function(){
      $(".navbar-vertical").click(function () {
        $('.vertical-wrapper').fadeToggle(300);
      });
      ...
      if ($(window).width() < 1200) {
        ...
        $( ".product-item .swatch-list li" ).hover(function() {
          var link = $(this).find('a').data('image');
          $(this).parent().prev().find('img').attr('src',link);
        });
      }
    ...
    initaddjs: function(){
      $(document).ready(function() {
         $('.widget-collection .collect').hover(function() {
